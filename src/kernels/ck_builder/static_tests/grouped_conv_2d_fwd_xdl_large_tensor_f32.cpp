...
// Test instance using the DeviceGroupedConvFwdMultipleD_Xdl_CShuffle_Large_Tensor helper
// This matches the F32 instance from CK's device_grouped_conv_fwd_xdl_large_tensor_instance.hpp:96
//
...
constexpr auto grouped_conv_2d_fwd_xdl_large_tensor_f32_instance_1 =
    DeviceGroupedConvFwdMultipleD_Xdl_CShuffle_Large_Tensor<0>(
...
static_assert(is_valid_kernel_instance<grouped_conv_2d_fwd_xdl_large_tensor_f32_instance_1>);

// Verify the instance satisfies the concept
static_assert(ckb::factory::LargeTensorAlgorithm<
              decltype(grouped_conv_2d_fwd_xdl_large_tensor_f32_instance_1.algorithm)>);
