    ...
    std::vector<std::unique_ptr<DeviceOp>>& instances)
{
    ...
    add_device_operation_instances<device_grouped_conv_fwd_xdl_int8_comp_instances<0>(
    ...
    {
        add_device_operation_instances<device_grouped_conv_fwd_xdl_int8_comp_instances_part2<0>(
            2, NHWGC, GKYXC, {}, NHWGK, ConvFwdDefault)>(instances);
    ...
    if(miopen::get_device_name() == "gfx950")
    {
        add_device_operation_instances<device_grouped_conv_fwd_xdl_int8_comp_instances_2x<0>(
            2, NHWGC, GKYXC, {}, NHWGK, ConvFwdDefault)>(instances);
