    ...
    std::vector<std::unique_ptr<DeviceOp>>& instances)
{
    ...
    if(miopen::get_device_name() == "gfx950")
    {
        ...
        add_device_operation_instances<
            device_grouped_conv_fwd_xdl_merged_groups_f16_v3_instances_2x<0>(
    ...
    else
    {
        ...
        // V3 instances
        add_device_operation_instances<device_grouped_conv_fwd_xdl_merged_groups_f16_v3_instances<
            0>(2, NHWGC, GKYXC, {}, NHWGK, ConvFwdDefault)>(instances);
